...
public abstract class Box extends Rectangle {
     ...
     */
    protected Box(double x, double y, double width, double height, boolean originIsCenter) {
        super(x, y, width, height);
     ...
     */
    protected Box(double x, double y, double width, double height, double angle) {
        super(x, y, width, height);
        center = new Point2D(x +width/2,y +height/2);
        this.angle = angle;
        this.rotate(angle);
    ...
    /**
     * Creates a new instance of Box with the given position and size.
     ...
     */
    protected Box(double x, double y, double width, double height, double angle, Color fillColor) {
        super(x, y, width, height);
        center = new Point2D(x +width/2,y +height/2);
        this.angle = angle;
        this.rotate(angle);
     ...
     */
    protected Box(double x, double y, double width, double height, double angle, ImagePattern texture) {
        super(x, y, width, height);
        center = new Point2D(x +width/2,y +height/2);
        this.angle = angle;
        this.rotate(angle);
     ...
     * @param originIsCenter true if the position should be the center of the shape
     */
    protected Box(double x, double y, double width, double height, double angle, boolean originIsCenter) {
        super(x, y, width, height);
     ...
     * @param originIsCenter true if the position should be the center of the shape
     */
    protected Box(double x, double y, double width, double height, double angle, Color fillColor, boolean originIsCenter) {
        super(x, y, width, height);
     ...
     * @param originIsCenter true if the position should be the center of the shape
     */
    public Box(double x, double y, double width, double height, double angle, ImagePattern texture, boolean originIsCenter) {
        super(x, y, width, height);
    ...
    public boolean boundingBoxCollision(Box other){
